...
<a:Dj:1056162947925299241>•Music
<a:info5:1056161315128881192>•Information
<:playlist:1056163037888905216>•Playlists
<:config:1056170397915168789>•Config
    ...
    const collector = interaction.channel.createMessageComponentCollector({
      filter: (b) => {
        if (b.user.id === interaction.member.user.id) return true;
          ...
          b.reply({
            ephemeral: true,
            content: `Only **${interaction.member.user.username}** can use this button, run the command again to use the help menu.`,
          });
          return false;
        }
      },
