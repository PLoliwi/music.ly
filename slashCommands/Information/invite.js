...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    const mainPage = new EmbedBuilder()
      ...
      .addFields([
        {
          name: "invite lavamusic",
          value: `[Here](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=36768832&scope=applications.commands%20bot)`,
        },
      ]);
