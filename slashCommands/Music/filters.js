...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    let thing = new EmbedBuilder().setColor(client.embedColor).setTimestamp();
    switch (filter) {
      case "bass":
      ...
      case "night":
        ...
        thing.setDescription(
          `${emojiequalizer} Nightcore Equalizer mode is ON`
        );
        break;
      case "pitch":
        player.setPitch(2);
      ...
      case "vapo":
        ...
        thing.setDescription(
          `${emojiequalizer} Vaporwave Equalizer mode is ON`
        );
        break;
      case "clear":
        player.clearEffects();
